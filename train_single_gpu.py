...
train_loader, val_loader, test_loader = get_data_loaders(output_excel_file, cleaned_dataset_dir, batch_size=16, drop_last=True)
...
print("\nActual Findings: ", finding_batch[0])
